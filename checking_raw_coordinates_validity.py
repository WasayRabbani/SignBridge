...
# --- CONFIGURATION ---
NPY_FILE = r"D:\New Extracted\Bathroom\Bathroom_19.npy"
...
print(
    f"Loaded: {sequence.shape[0]} frames, {sequence.shape[1]} values per frame")
...
for frame_data in sequence:
    ...
    for x, y, z in pose:
        if x != 0.0 and y != 0.0:
            cv2.circle(image, (int(x * WIDTH), int(y * HEIGHT)),
                       5, (0, 255, 0), -1)  # Green
